...
java -Xmx2g -jar /opt/PepPrograms/picard-tools-1.138/picard.jar MarkDuplicates I=$1_SE_sort_TN.bam O=$1.dedup.bam M=$1.metrics REMOVE_DUPLICATES=true AS=true VALIDATION_STRINGENCY=SILENT
